package com.alltranslator.voicetotext.languagetranslator.utils;
...
//    }
    ...
    public void setLanguages(List<LanguagesModel> list) {
        putLanguagesModelListObject("languages", list);
    }

    public List<LanguagesModel> getLanguages() {
        return getLanguagesModelListObject("languages");
    }

    public void putLanguagesModelListObject(String key, List<LanguagesModel> objArray) {
        Gson gson = new Gson();
        List<String> objStrings = new ArrayList<>();
        for (LanguagesModel obj : objArray) {
//            Type collectionType = new TypeToken<String>(){}.getType();
            String value = gson.toJson(obj);
            objStrings.add(value);
        }
        putListString(key, objStrings);
    }

    public List<LanguagesModel> getLanguagesModelListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        List<LanguagesModel> objects = new ArrayList<>();

        for (String jObjString : objStrings) {
//            LanguagesModel value = gson.fromJson(jObjString, LanguagesModel.class);
            Type collectionType = new TypeToken<LanguagesModel>(){}.getType();
            LanguagesModel value = gson.fromJson(jObjString, collectionType);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void removeLanguages() {
        getLanguagesModelListObject("languages").clear();
    }

    public void setAPIKEY(String apikey) {
        putString("API_KEY", "AIzaSyDcq5ncLTqYQvjJppZ6wqH6nmN2upGkRu4");
    }

    public String getAPIKEY() {
        return "AIzaSyDcq5ncLTqYQvjJppZ6wqH6nmN2upGkRu4";
